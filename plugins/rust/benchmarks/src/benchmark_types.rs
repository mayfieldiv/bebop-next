...
// source: lab/benchmark/c/schemas/benchmark.bop
...
use alloc::vec;
use bebop_runtime::{BebopDecode, BebopDuration, BebopEncode, BebopFlags, BebopReader, BebopTimestamp, BebopWriter, DecodeError, bf16, f16};
...
impl<'buf> Person<'buf> {
  pub fn new(id: i32, name: impl ::core::convert::Into<alloc::borrow::Cow<'buf, str>>, email: impl ::core::convert::Into<alloc::borrow::Cow<'buf, str>>, age: i32) -> Self {
...
impl<'buf> BebopDecode<'buf> for Person<'buf> {
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    ::core::result::Result::Ok(Person { id, name, email, age })
  }
}
...
impl<'buf> Order<'buf> {
  pub fn new(order_id: i64, customer_id: i64, item_ids: impl ::core::convert::Into<alloc::borrow::Cow<'buf, [i64]>>, quantities: impl ::core::convert::Into<alloc::borrow::Cow<'buf, [i32]>>, total: f64, timestamp: i64) -> Self {
...
impl<'buf> BebopDecode<'buf> for Order<'buf> {
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    ::core::result::Result::Ok(Order { order_id, customer_id, item_ids, quantities, total, timestamp })
  }
}
...
impl<'buf> Event<'buf> {
  pub fn new(id: i64, r#type: impl ::core::convert::Into<alloc::borrow::Cow<'buf, str>>, source: impl ::core::convert::Into<alloc::borrow::Cow<'buf, str>>, timestamp: i64, payload: impl ::core::convert::Into<::bebop_runtime::BebopBytes<'buf>>) -> Self {
...
impl<'buf> BebopDecode<'buf> for Event<'buf> {
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    ::core::result::Result::Ok(Event { id, r#type, source, timestamp, payload })
  }
}
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    while reader.position() < end {
      ...
      match tag {
        ...
        2 => msg.children = ::core::option::Option::Some(reader.read_array(|_r| TreeNode::decode(_r))?),
        tag => { return ::core::result::Result::Err(DecodeError::InvalidField { type_name: "TreeNode", tag }); }
      }
    }
...
impl<'buf> BebopDecode<'buf> for JsonValue<'buf> {
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    let value = match discriminator {
      ...
      _ => ::core::result::Result::Err(DecodeError::InvalidUnion { type_name: "JsonValue", discriminator }),
    };
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    while reader.position() < end {
      ...
      match tag {
        ...
        tag => { return ::core::result::Result::Err(DecodeError::InvalidField { type_name: "Bool", tag }); }
      }
    }
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    while reader.position() < end {
      ...
      match tag {
        ...
        tag => { return ::core::result::Result::Err(DecodeError::InvalidField { type_name: "Number", tag }); }
      }
    }
...
impl<'buf> String<'buf> {
  pub fn into_owned(self) -> StringOwned {
    String {
      value: self.value.map(|v| alloc::borrow::Cow::Owned(v.into_owned())),
    }
  }
}
...
impl<'buf> BebopDecode<'buf> for String<'buf> {
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    while reader.position() < end {
      ...
      if tag == 0 { break; }
      match tag {
        1 => msg.value = ::core::option::Option::Some(alloc::borrow::Cow::Borrowed(reader.read_str()?)),
        tag => { return ::core::result::Result::Err(DecodeError::InvalidField { type_name: "String", tag }); }
      }
    }
...
impl<'buf> BebopDecode<'buf> for List<'buf> {
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    while reader.position() < end {
      ...
      if tag == 0 { break; }
      match tag {
        1 => msg.values = ::core::option::Option::Some(reader.read_array(|_r| JsonValue::decode(_r))?),
        tag => { return ::core::result::Result::Err(DecodeError::InvalidField { type_name: "List", tag }); }
      }
    }
...
pub struct Object<'buf> {
  pub fields: ::core::option::Option<::bebop_runtime::HashMap<alloc::borrow::Cow<'buf, str>, JsonValue<'buf>>>,
}
...
impl<'buf> Object<'buf> {
  pub fn into_owned(self) -> ObjectOwned {
    Object {
      fields: self.fields.map(|v| v.into_iter().map(|(_k, _v)| (alloc::borrow::Cow::Owned(_k.into_owned()), _v.into_owned())).collect()),
    }
  }
}
...
impl<'buf> BebopDecode<'buf> for Object<'buf> {
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    while reader.position() < end {
      ...
      if tag == 0 { break; }
      match tag {
        1 => msg.fields = ::core::option::Option::Some(reader.read_map(|_r| ::core::result::Result::Ok((::core::result::Result::Ok(alloc::borrow::Cow::Borrowed(_r.read_str()?))?, JsonValue::decode(_r)?)))?),
        tag => { return ::core::result::Result::Err(DecodeError::InvalidField { type_name: "Object", tag }); }
      }
    }
...
pub struct Document<'buf> {
  ...
  pub metadata: ::core::option::Option<::bebop_runtime::HashMap<alloc::borrow::Cow<'buf, str>, JsonValue<'buf>>>,
}
...
impl<'buf> Document<'buf> {
  pub fn into_owned(self) -> DocumentOwned {
    Document {
      title: self.title.map(|v| alloc::borrow::Cow::Owned(v.into_owned())),
      body: self.body.map(|v| alloc::borrow::Cow::Owned(v.into_owned())),
      metadata: self.metadata.map(|v| v.into_iter().map(|(_k, _v)| (alloc::borrow::Cow::Owned(_k.into_owned()), _v.into_owned())).collect()),
    }
  }
}
...
impl<'buf> BebopDecode<'buf> for Document<'buf> {
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    while reader.position() < end {
      ...
      if tag == 0 { break; }
      match tag {
        1 => msg.title = ::core::option::Option::Some(alloc::borrow::Cow::Borrowed(reader.read_str()?)),
        2 => msg.body = ::core::option::Option::Some(alloc::borrow::Cow::Borrowed(reader.read_str()?)),
        3 => msg.metadata = ::core::option::Option::Some(reader.read_map(|_r| ::core::result::Result::Ok((::core::result::Result::Ok(alloc::borrow::Cow::Borrowed(_r.read_str()?))?, JsonValue::decode(_r)?)))?),
        tag => { return ::core::result::Result::Err(DecodeError::InvalidField { type_name: "Document", tag }); }
      }
    }
...
impl ::core::convert::TryFrom<u8> for ChunkKind {
  ...
  fn try_from(value: u8) -> ::core::result::Result<Self, DecodeError> {
    match value {
      ...
      _ => ::core::result::Result::Err(DecodeError::InvalidEnum { type_name: "ChunkKind", value: value as u64 }),
    }
  }
}
...
impl<'buf> ChunkedText<'buf> {
  pub fn new(source: impl ::core::convert::Into<alloc::borrow::Cow<'buf, str>>, spans: alloc::vec::Vec<TextSpan>) -> Self {
    let source = ::core::convert::Into::into(source);
    Self { source, spans }
  }
}
...
impl<'buf> EmbeddingBf16<'buf> {
  pub fn new(id: ::bebop_runtime::Uuid, vector: impl ::core::convert::Into<alloc::borrow::Cow<'buf, [bf16]>>) -> Self {
...
impl<'buf> EmbeddingF32<'buf> {
  pub fn new(id: ::bebop_runtime::Uuid, vector: impl ::core::convert::Into<alloc::borrow::Cow<'buf, [f32]>>) -> Self {
    let vector = ::core::convert::Into::into(vector);
    Self { id, vector }
  }
}
...
impl<'buf> EmbeddingBatch<'buf> {
  pub fn new(model: impl ::core::convert::Into<alloc::borrow::Cow<'buf, str>>, embeddings: alloc::vec::Vec<EmbeddingBf16<'static>>, usage_tokens: u32) -> Self {
...
impl<'buf> BebopDecode<'buf> for EmbeddingBatch<'buf> {
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    ::core::result::Result::Ok(EmbeddingBatch { model, embeddings, usage_tokens })
  }
}
...
impl<'buf> TokenLogprob<'buf> {
  pub fn new(token: impl ::core::convert::Into<alloc::borrow::Cow<'buf, str>>, token_id: u32, logprob: f32) -> Self {
...
impl<'buf> BebopDecode<'buf> for TokenLogprob<'buf> {
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    ::core::result::Result::Ok(TokenLogprob { token, token_id, logprob })
  }
}
...
impl<'buf> LlmStreamChunk<'buf> {
  pub fn new(chunk_id: u32, tokens: alloc::vec::Vec<alloc::string::String>, logprobs: alloc::vec::Vec<TokenAlternatives<'static>>, finish_reason: impl ::core::convert::Into<alloc::borrow::Cow<'buf, str>>) -> Self {
...
impl<'buf> LlmStreamChunk<'buf> {
  pub fn into_owned(self) -> LlmStreamChunkOwned {
    LlmStreamChunk {
      ...
      tokens: self.tokens.into_iter().map(|_e| alloc::borrow::Cow::Owned(_e.into_owned())).collect(),
...
impl<'buf> BebopDecode<'buf> for LlmStreamChunk<'buf> {
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    let tokens = reader.read_array(|_r| ::core::result::Result::Ok(alloc::borrow::Cow::Borrowed(_r.read_str()?)))?;
    ...
    ::core::result::Result::Ok(LlmStreamChunk { chunk_id, tokens, logprobs, finish_reason })
  }
}
...
impl<'buf> TensorShard<'buf> {
  pub fn new(name: impl ::core::convert::Into<alloc::borrow::Cow<'buf, str>>, shape: impl ::core::convert::Into<alloc::borrow::Cow<'buf, [u32]>>, dtype: impl ::core::convert::Into<alloc::borrow::Cow<'buf, str>>, data: impl ::core::convert::Into<alloc::borrow::Cow<'buf, [bf16]>>, offset: u64, total_elements: u64) -> Self {
    let name = ::core::convert::Into::into(name);
...
impl<'buf> BebopDecode<'buf> for TensorShard<'buf> {
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    ::core::result::Result::Ok(TensorShard { name, shape, dtype, data, offset, total_elements })
  }
}
...
impl InferenceTiming {
  ...
  pub fn new(queue_time: BebopDuration, inference_time: BebopDuration, tokens_per_second: f32) -> Self {
...
impl<'buf> BebopDecode<'buf> for InferenceTiming {
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    ::core::result::Result::Ok(InferenceTiming { queue_time, inference_time, tokens_per_second })
  }
}
...
impl<'buf> InferenceResponse<'buf> {
  pub fn new(request_id: ::bebop_runtime::Uuid, embeddings: alloc::vec::Vec<EmbeddingBf16<'static>>, timing: InferenceTiming) -> Self {
...
impl<'buf> BebopDecode<'buf> for InferenceResponse<'buf> {
  ...
  fn decode(reader: &mut BebopReader<'buf>) -> ::core::result::Result<Self, DecodeError> {
    ...
    ::core::result::Result::Ok(InferenceResponse { request_id, embeddings, timing })
  }
}
