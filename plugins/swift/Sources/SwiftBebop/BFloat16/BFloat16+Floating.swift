...
extension BFloat16: BinaryFloatingPoint {
    ...
    @inlinable
    static var _infinityExponent: UInt16 { 1 &<< UInt16(exponentBitCount) - 1 }

    @inlinable
    static var _exponentBias: UInt16 { _infinityExponent &>> 1 }

    @inlinable
    static var _significandMask: UInt16 { 1 &<< UInt16(significandBitCount) - 1 }

    @inlinable
    static var _quietNaNMask: UInt16 { 1 &<< UInt16(significandBitCount - 1) }
