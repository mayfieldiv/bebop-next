...
- [x] `PartialEq`/`Eq`/`Hash` derives on eligible types (float/map-aware) → [[derive-traits]]
- [ ] Serde integration (feature-gated) → [[serde-integration]]
- [x] Timestamp/Duration newtypes → [[temporal-newtypes]] ✅ 2026-02-20
- [x] UUID crate integration (feature-gated) → [[uuid-integration]] ✅ 2026-02-20
- [x] Dead code in type_mapper.rs → [[dead-code-cleanup]]
- [x] Rename `_cow` suffixed functions → [[rename-cow-functions]]
